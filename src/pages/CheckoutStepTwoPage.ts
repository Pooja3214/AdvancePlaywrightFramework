...
export class CheckoutStepTwoPage extends BasePage{
    ...
    private readonly taxLable: Locator;
    private readonly totalLable: Locator;
    ...
    constructor (page:Page){
        ...
        this.taxLable= page.locator('[data-test="tax-label"]');
    ...
    async parseMoney(loc: Locator):Promise<number>{
    ...
    async tax(): Promise<number>{
        return this.parseMoney(this.taxLable);
    }

    async total(): Promise<number>{
        return this.parseMoney(this.totalLable);
    }
